  ...
  <fieldset class='fieldset_basic'>
    <ul>
      <c:choose>
        ...
        <c:when test="${param.code == 'update_success'}"> <%-- Java if --%>
          ...
          <li class='li_none'>
            ...
            <button type='button' 
                         onclick="location.href='/crew/list.do'"
      ...
      <li class='li_none'>
        ...
        <%-- <a href="./list_by_cfoodno.do?cfoodno=${param.cfoodno}" class="btn btn-primary">목록</a> --%>
        <%-- <button type='button' onclick="location.href='./list_by_cfoodno_search.do?cfoodno=${param.cfoodno}'" class="btn btn-primary">목록</button> --%>
        <%-- <button type='button' onclick="location.href='./list_by_cfoodno_search_paging.do?cfoodno=${param.cfoodno}'" class="btn btn-primary">목록</button> --%>
