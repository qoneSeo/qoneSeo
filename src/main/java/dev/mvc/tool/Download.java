...
// dev.mvc.cfood_v1sbm3c.ServletRegister.java에서 등록
public class Download extends javax.servlet.http.HttpServlet {
  ...
  protected void doProcess(HttpServletRequest request,
    ...
    // 저장 폴더를 절대 경로로 변환, /creates/storage, /notice/storage, /crew/storage...
    String dir =  Tool.getOSPath() + request.getParameter("dir");
    // 완성된 경로 dir: C:/kd/deploy/food_v2sbm3c/creates/storage/
