...
<c:set var="cfoodno" value="${param.cfoodno }" /> <%-- mav.addObject("cfoodno", CreatesVO.getCfoodno()); // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do?cfoodno=${cfoodno}'" class="btn btn-secondary btn-sm">새로운 컨텐츠 등록</button>
        <button type='button' onclick="location.href='./list_by_cfoodno_grid.do?cfoodno=${cfoodno}'" class="btn btn-secondary btn-sm">목록</button>
      </LI>
    </UL>
  </fieldset>
