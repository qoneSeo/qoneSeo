...
<c:import url="/menu/top.do" />
  <DIV class='title_line'><A href="/creates/list_by_cfoodno.do?cfoodno=${foodVO.cfoodno }" class="title_link">${foodVO.name }</A> > ${CreatesVO.title } > Youtube 등록/수정/삭제</DIV>
  ...
  <FORM name='frm_youtube' method='POST' action='./youtube.do'>
    ...
    <div>
       ...
       <textarea name='youtube' class="form-control" rows="12" style='width: 100%;'>${CreatesVO.youtube }</textarea>
    </div>
  ...
  <DIV style="text-align: center;">
      ...
      <IMG src='/creates/images/youtube01.jpg' style='width: 60%;'><br><br>
      <IMG src='/creates/images/youtube02.jpg' style='width: 60%;'><br>
  </DIV>
